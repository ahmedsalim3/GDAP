...
class ModelEvaluation:
    ...
    def _pr_curve_auc(self):
        precision_1, recall_1, _ = precision_recall_curve(self.y_test, self.y_pred_proba)
        pr_auc_1 = average_precision_score(self.y_test, self.y_pred_proba)

        precision_0, recall_0, _ = precision_recall_curve(1 - self.y_test, 1 - self.y_pred_proba)
    ...
    def plot_evaluation(self):
        ...
        fontsize = max(8, min(12, self.figsize[1] * 1.5))
        ...
        ax0.set_title("Confusion Matrix", fontsize=fontsize)
        ...
        ax2.set_title("ROC Curves", fontsize=fontsize)
        ...
        ax3.set_title("Precision-Recall Curves", fontsize=fontsize)
        ...
        ax4.set_title("Probability Distribution of Predictions", fontsize=fontsize)
        ax4.grid(False)
        ...
        if self.output_dir:
            ...
            save_path = os.path.join(
                self.output_dir, f"{self.model_name if self.model_name is not None else 'model'}_evaluation.png"
            )
