...
@st.cache_resource
def _Node2Vec():
    from gene_disease.embeddings import Node2Vec
...
@st.cache_resource
def _ProNE():
    from gene_disease.embeddings import ProNE
...
@st.cache_resource
def _GGVec():
    from gene_disease.embeddings import GGVec
...
def embedding_generator(G, embeddings_mode):
    if embeddings_mode == "Node2Vec Model":
        ...
        from gene_disease.embeddings import EmbeddingGenerator
